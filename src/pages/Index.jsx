...
const Index = () => {
  return (
    <Box>
        ...
        <VStack spacing={8} align="center" maxW="6xl" mx="auto" px={6}>
          ...
          <Stack direction={{ base: "column", md: "row" }} spacing={8}>
            <Box bg="white" p={6} borderRadius="md" boxShadow="md" textAlign="center">
              <Icon as={FaHeart} h={12} w={12} color="teal.500" mb={4} />
            ...
            <Box bg="white" p={6} borderRadius="md" boxShadow="md" textAlign="center">
              <Icon as={FaLeaf} h={12} w={12} color="teal.500" mb={4} />
              <Heading as="h3" size="lg" mb={4}>
                Premium Package
              </Heading>
        ...
        <VStack spacing={8} align="center" maxW="6xl" mx="auto" px={6}>
          ...
          <Stack direction={{ base: "column", md: "row" }} spacing={8}>
            <Box bg="gray.100" p={6} borderRadius="md">
              ...
              <Link href="#" color="teal.500" mt={4} display="block">
                Read More
              </Link>
            </Box>
            <Box bg="gray.100" p={6} borderRadius="md">
      ...
      {/* Footer */}
      <Box bg="teal.500" py={10} color="white" textAlign="center">
